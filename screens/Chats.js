...
import { SafeAreaView,ImageBackground, StyleSheet, ScrollView, Pressable, Alert, ActivityIndicator, Text, View, TouchableOpacity } from "react-native";
...
const Chats = ({ setUnreadCount }) => {
    ...
    useEffect(() => {
        ...
        navigation.setOptions({
            headerStyle: {
                backgroundColor: 'skyblue', // Navigation bar ka background black
            },
            headerTitleAlign: 'center', // Title center me hoga
            headerTintColor: 'white', // Back button aur icons ka color white
            headerTitleStyle: {
                color: 'white', // Header title ka text color white
                fontWeight: 'bold', // Header title ka font bold
                fontSize: 27, // Header title ka font size 20
                 fontStyle:'italic', // Header title ka font italic
            },
        });
    ...
    return (
        <ImageBackground
        source={require('../assets/chatsbackground.png')} // Image ka path yahaan specify karein
        style={styles.backgroundImage} // Custom style use karenge
    >
        ...
        <Pressable style={styles.container} onPress={deSelectItems}>
            {loading ? (
                ...
                <ScrollView>
                    ...
                    <Separator />
                    <View style={styles.blankContainer}>
                        <Text style={{ fontSize: 11, margin: 15 }}>
                            <Ionicons name="lock-open" size={11} style={{ color: '#565656' }} /> Your personal messages are not <Text style={{ color: colors.teal }}>end-to-end-encrypted</Text>
                        </Text>
                    </View>
                </ScrollView>
            )}
...
const styles = StyleSheet.create({
    backgroundImage: {
        ...
        resizeMode: 'cover', // Image apne aspect ratio me stretch karega
    },
    container: {
        flex: 1,
        backgroundColor: 'transparent', // Image ko dikhaane ke liye background transparent karein
    },
    fab: {
        position: 'absolute',
        bottom: 12,
